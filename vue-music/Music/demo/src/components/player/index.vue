                ...
                <div class="bottom">
                    ...
                    <div class="progress-wrapper">
                        ...
                        <div class="progress-bar-wrapper">
                            <progressBar :percent="percent" @percentChange="changeProgressTime"></progressBar>
                        </div>
...
export default {
    ...
    methods:{
        ...
        //根据子组件传回来的比分比来计算当前需要播放的歌曲时间
        changeProgressTime(v){
        ...
        hanlder({lineNum,txt}){
            ...
            if(lineNum > 5){
                ...
                this.$refs.lyriclist.scrollToElement(0,0,300)
            }
            this.currentLyc = txt           
        },
        onChangeMode(){
...
<style lang="less">
  ...
  .player{
      .normal-player{
              ...
              .middle-l{
                  ...
                  .cd-wrapper{
                      ...
                      .cd{
                          ...
                          border:10 px solid rgba(255,255,255,0.1);
                          border-radius: 50%;
                          &.play{
          ...
          &.normal-enter-acter,&.normal-leave-active{
              transition: all 0.4s;
              .top,.bottom{
